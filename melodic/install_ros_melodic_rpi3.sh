...
echo ""
echo "[Note] Target OS version  >>> Ubuntu 18.04 Mate (bionic)"
...
sudo apt install -y python-rosinstall git clang-format-6.0 vim python-flake8 git python-rosinstall-generator python-wstool build-essential
